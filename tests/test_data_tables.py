...
class Testdata_tables(TestCase):
    ...
    def test_get_table_class(self):
        t = self.tables.get_table_class("User_info")
        self.assertIsNotNone(t)
        t = self.tables.get_table_class("Addresses")
        self.assertIsNotNone(t)
        t = self.tables.get_table_class("Listing")
        self.assertIsNotNone(t)
        t = self.tables.get_table_class("Order_info")
        self.assertIsNotNone(t)
    ...
    def test_add_user_info(self):
        ...
        is_success = self.tables.add_user_info(new_user)
    ...
    def test_add_address(self):
        ...
        is_success = self.tables.add_address(new_address)
        self.assertTrue(is_success)
    ...
    def test_update_info(self):
        ...
        new_values = {"city": "NJ",
                      "zipcode": "12345"}
        is_success = self.tables.update_info(table_name=table_name, template=template,
                                new_values=new_values)
        self.assertTrue(is_success)
        # Query
        res, _ = self.tables.get_info(table_name=table_name, template=template)
        res = res.to_json(orient="table")
        parsed = json.loads(res)
        data = parsed['data'][0]
    ...
    def test_update_info_empty_name(self):
        ...
        new_values = {"emai": "NJ",
                      "zipcode": "12345"}
        is_success = self.tables.update_info(table_name, template, new_values)
        self.assertFalse(is_success)
